// This file is autogenerated from `../tst/event.local.src, ../tst/event.extra.src'. Do not edit, your changes will be lost!
...
enum {
    ...
    EV_EXTRA_1 = 2,                     // Frobs the foo.
    EV_EXTRA_2 = 3,                     // Frobs the foo some more.
    COUNT_EV = 4,                       // Total number of events defined.
};
...
#define EVENT_DECLARE_EVENT_NAMES()                                                     \
 ...
 static const char EVENT_NAMES_2[] PROGMEM = "EXTRA_1";                                 \
 static const char EVENT_NAMES_3[] PROGMEM = "EXTRA_2";                                 \
                                                                                        \
...
#define EVENT_DECLARE_EVENT_DESCS()                                                                                                         \
 ...
 static const char EVENT_DESCS_2[] PROGMEM = "Frobs the foo.";                                                                              \
 static const char EVENT_DESCS_3[] PROGMEM = "Frobs the foo some more.";                                                                    \
                                                                                                                                            \
